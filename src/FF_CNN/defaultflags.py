...
flags.DEFINE_integer('use_num_images', -1, "Num of images used for training. (-1 for all)")  # int
flags.DEFINE_string('use_dataset', "mnist", "Name of a multiclass dataset, e.g. 'cifar10'")  # str
flags.DEFINE_float('use_portion', 0.1, "fraction of the dataset to be used. 1.0 for all")  # float
